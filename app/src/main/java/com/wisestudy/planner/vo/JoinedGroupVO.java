...
public class JoinedGroupVO extends BaseExpandableListAdapter {
    ...
    public JoinedGroupVO(ArrayList<String> joinedGoup, Map<String, ArrayList<String>> joinedGroupChild, Context expandableContext) {
